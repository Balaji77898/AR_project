 ...
 const downloadInvoice = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#FBF6EE] via-[#F5EFE0] to-[#FBF6EE] pb-40 relative">
      ...
      <div className="sticky top-0 z-50 bg-gradient-to-r from-[#5D1616] via-[#7B1F1F] to-[#5D1616] shadow-[0_4px_20px_rgba(0,0,0,0.3)]">
        <div className="px-4 py-4 flex items-center justify-between text-[#FFF8E1]">
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 rounded-lg bg-[#2D0A0F]/40 border border-[#C8A951]/30 hover:bg-[#2D0A0F]/60 transition-all duration-300"
      ...
      {cart.length > 0 && !showConfirm && (
        <div className="fixed bottom-4 left-4 right-4 z-50 flex flex-col gap-3 max-w-md mx-auto">
          <button
            ...
            className="flex items-center justify-center gap-2 border-2 border-[#7B1F1F] text-[#7B1F1F] py-4 rounded-xl bg-white shadow-lg hover:bg-[#FBF6EE] hover:scale-[1.02] transition-all duration-300 font-semibold"
            style={{ fontFamily: "'Poppins', sans-serif" }}
          >
          ...
          <button
            onClick={placeOrder}
            className="group flex items-center justify-center gap-2 bg-gradient-to-r from-[#7B1F1F] to-[#5D1616] text-white py-4 rounded-xl shadow-xl hover:shadow-2xl hover:scale-[1.02] transition-all duration-300 font-bold"
            style={{ fontFamily: "'Poppins', sans-serif" }}
          >
            <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
      ...
      {/* CONFIRMATION STATE */}
      {showConfirm && (
        <div className="fixed inset-0 bg-gradient-to-br from-[#C8A951] to-[#D4B76E] flex flex-col items-center justify-center z-50 px-4 animate-fade-in">
          <div className="w-24 h-24 mb-6 rounded-full bg-white flex items-center justify-center animate-scale-in">
            <svg className="w-12 h-12 text-[#5D1616]" viewBox="0 0 24 24" fill="currentColor">
              <path d="M9 16.17L4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41z"/>
            </svg>
          </div>
          <h3 className="text-4xl font-bold mb-3 text-[#2D0A0F] text-center" style={{ fontFamily: "'Playfair Display', serif" }}>
            Order Confirmed!
          </h3>
          <p className="text-xl text-[#5D1616] mb-8 text-center" style={{ fontFamily: "'Poppins', sans-serif" }}>
            Thank you for dining with Royal Spice
          </p>
          <button
            onClick={() => router.push("/customer/order-status")}
            className="px-8 py-4 bg-gradient-to-r from-[#7B1F1F] to-[#5D1616] text-white rounded-xl shadow-2xl hover:scale-105 transition-all duration-300 font-bold flex items-center gap-2"
            style={{ fontFamily: "'Poppins', sans-serif" }}
          >
            VIEW ORDER STATUS
            <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
