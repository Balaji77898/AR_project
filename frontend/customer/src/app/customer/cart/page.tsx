      ...
      <div className="sticky top-0 z-40 bg-gradient-to-r from-[#5D1616] via-[#7B1F1F] to-[#5D1616] shadow-[0_4px_20px_rgba(0,0,0,0.3)]">
        <div className="px-4 py-4 flex items-center justify-between text-[#FFF8E1]">
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 rounded-lg bg-[#2D0A0F]/40 border border-[#C8A951]/30 hover:bg-[#2D0A0F]/60 hover:border-[#C8A951]/50 transition-all duration-300"
