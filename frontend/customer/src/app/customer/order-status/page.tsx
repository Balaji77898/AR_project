    ...
    <div className="min-h-screen bg-gradient-to-br from-[#FBF6EE] via-[#F5EFE0] to-[#FBF6EE] pb-32">
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white/95 backdrop-blur-md border-t-2 border-[#C8A951]/50 p-4 flex gap-3 shadow-[0_-10px_40px_rgba(0,0,0,0.15)] z-50">
        <button
          ...
          className="flex-1 bg-gradient-to-r from-[#7B1F1F] to-[#5D1616] text-white py-4 rounded-xl font-bold hover:scale-[1.02] transition-all duration-300 shadow-lg flex items-center justify-center gap-2"
        ...
        <button
          onClick={handleDone}
          className="flex-1 border-2 border-[#7B1F1F] text-[#7B1F1F] py-4 rounded-xl font-bold hover:bg-[#FBF6EE] hover:scale-[1.02] transition-all duration-300 flex items-center justify-center gap-2"
          style={{ fontFamily: "'Poppins', sans-serif" }}
        >
          <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
